...
int main() {
	...
	main << (HTML::Table().cls("table table-hover table-sm")
		...
		<< (HTML::Row() << (HTML::Col() << HTML::Link("repotest.ru", "http://repotest.ru/index.html"))
		...
		<< (HTML::Row() << (HTML::Col() << HTML::Link("wordle-task.repotest.ru", "http://wordle-task.repotest.ru/wordle-task.html"))
